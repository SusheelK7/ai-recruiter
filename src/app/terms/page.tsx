  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] px-4 py-24 text-[#101828] dark:bg-[#0F1420] dark:text-zinc-100 sm:px-6">
      <div className="mx-auto max-w-3xl rounded-3xl border border-zinc-200 bg-white/85 p-8 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-white/5 sm:p-10">
        <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#2E5B8A] dark:text-[#9DC4F0]">Terms</p>
        <h1 className="mt-3 text-3xl font-bold tracking-tight">Terms of Service</h1>
        <p className="mt-4 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
          Placeholder terms page for now. Add the final legal copy before production launch.
        </p>
        <div className="mt-8">
